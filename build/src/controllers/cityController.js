...
var cityController = /** @class */ (function () {
    function cityController(service) {
        var _this = this;
        this.service = service;
        this.getCitys = function (ctx) { return __awaiter(_this, void 0, void 0, function () {
            var citys;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(this);
                        return [4 /*yield*/, this.service.getCitys()];
                    case 1:
                        citys = _a.sent();
                        ctx.body = citys;
                        return [2 /*return*/];
        ...
        this.getIndex = function (ctx) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    cityController = __decorate([
        ...
        __param(0, container_ioc_1.Inject(cityService_1.cityService)),
